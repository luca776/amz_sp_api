...
# Unit tests for AmzSpApi::CatalogItemsApiModel::ClassificationRefinement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClassificationRefinement' do
  before do
    # run before each test
    @instance = AmzSpApi::CatalogItemsApiModel::ClassificationRefinement.new
  end
  ...
  describe 'test an instance of ClassificationRefinement' do
    it 'should create an instance of ClassificationRefinement' do
      expect(@instance).to be_instance_of(AmzSpApi::CatalogItemsApiModel::ClassificationRefinement)
    end
  end
